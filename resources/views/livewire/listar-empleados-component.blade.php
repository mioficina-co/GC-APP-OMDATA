            ...
            <table class="w-full table-auto border-collapse border border-gray-200 rounded-lg shadow-sm">
                <thead class="bg-gray-50">
                    <tr class="text-left text-sm font-semibold text-gray-700">
                        ...
                        <th class="border-b px-4 py-3">Departamento</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @foreach ($empleados as $empleadoItem)
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 text-sm text-gray-600">{{ $empleadoItem->id }}</td>
                            <td class="px-4 py-3 text-sm text-gray-600">{{ $empleadoItem->nombre }}</td>
