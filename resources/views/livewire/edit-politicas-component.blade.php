        ...
        <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60" :class="{ '!block': open }">
            <div class="flex min-h-screen items-center justify-center px-4" @click.self="open = false">
                <div x-show="open" x-transition.duration.300 class="panel my-8 w-full max-w-4xl overflow-hidden border-0 p-0 shadow-lg">
                    ...
                    <div class="p-5">
                        <form wire:submit.prevent="save" autocomplete="off" autocapitalize="off" spellcheck="false">
                            <div class="space-y-4">
                                <div>
                                    <label class="font-bold">Versión / Identificador</label>
                                    <input type="text" wire:model="version" class="form-input" placeholder="Ej: v1.1 - Marzo 2024" />
                                    @error('version')
                                ...
                                <div class="flex items-center gap-2 mt-2">
                                    <input type="checkbox" wire:model="activa" id="checkActiva" class="form-checkbox" />
