    ...
    <div>
        ...
        <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
            ...
            <div class="panel">
                ...
                <div x-data="{
                    visitantes: @entangle('visitantes'),
                    registrosMensuales: @entangle('registrosMensuales'),
                    concurrenciaUsuarios: @entangle('concurrenciaUsuarios'),
                    counterVisitantes: null,
                    counterRegistros: null,
                    counterConcurrencia: null,
                    init() {
                        this.$nextTick(() => {
                            // Inicializar contadores cuando el DOM esté listo
                            if (typeof countUp !== 'undefined') {
                                this.counterVisitantes = new countUp.CountUp(this.$refs.counterVisitantes, this.visitantes, { startVal: 0, duration: 7 });
                                this.counterRegistros = new countUp.CountUp(this.$refs.counterRegistros, this.registrosMensuales, { startVal: 0, duration: 7 });
                                this.counterConcurrencia = new countUp.CountUp(this.$refs.counterConcurrencia, this.concurrenciaUsuarios, { startVal: 0, duration: 7 });
                
                                // Iniciar animaciones
                                this.counterVisitantes.start();
                                this.counterRegistros.start();
                                this.counterConcurrencia.start();
                            } else {
                                console.error('CountUp no está cargado');
                            }
                        });
                    }
                }">
                    <div class="mb-5 grid grid-cols-3 justify-items-center gap-3 max-w-[900px] mx-auto">
                        ...
                        <div>
                            <div
                                ...
                                <h1 class="text-xl text-center text-primary sm:text-3xl" x-ref="counterVisitantes">0
                                </h1>
                            </div>
                            <h4
                        ...
                        <div>
                            <div
                                class="w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] shadow-[1px_2px_12px_0_rgba(31,45,61,0.10)] rounded-full border border-[#e0e6ed] dark:border-[#1b2e4b] flex justify-center flex-col">
                                <h1 class="text-xl text-center text-primary sm:text-3xl" x-ref="counterRegistros">0</h1>
                            </div>
                            <h4
                                class="text-[#3b3f5c] text-xs sm:text-[15px] mt-4 text-center dark:text-white-dark font-semibold">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <div>
                            <div
                                class="w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] shadow-[1px_2px_12px_0_rgba(31,45,61,0.10)] rounded-full border border-[#e0e6ed] dark:border-[#1b2e4b] flex justify-center flex-col">
                                <h1 class="text-xl text-center text-primary sm:text-3xl" x-ref="counterConcurrencia">0
                                </h1>
                            </div>
                            <h4
                                class="text-[#3b3f5c] text-xs sm:text-[15px] mt-4 text-center dark:text-white-dark font-semibold">
