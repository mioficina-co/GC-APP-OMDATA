    ...
    <div x-data="{ open: @entangle('showModal') }">
        <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60" :class="{ '!block': open }">
            <div class="flex justify-center items-center px-4 min-h-screen" @click.self="open = false">
                <div x-show="open" x-transition.duration.300 class="overflow-hidden p-0 my-8 w-full max-w-2xl border-0 shadow-lg panel">
                    ...
                    <div class="flex justify-between items-center p-5 text-lg font-bold text-white bg-warning">
                        ...
                        <button type="button" @click="open = false" class="hover:opacity-70"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path d="M18 6L6 18M6 6l12 12" stroke-width="2" stroke-linecap="round"></path>
                            </svg></button>
                    </div>

                    <div class="p-6">
                        <form wire:submit.prevent="update" autocomplete="off" autocapitalize="off" spellcheck="false" class="space-y-5">
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <div class="col-span-2">
                                    <label class="text-xs font-bold text-gray-500 uppercase">Especifique el
                                        motivo</label>
                                    <input type="text" wire:model="otra_razon_visita" class="form-input" placeholder="¿Cuál es el motivo?" />
                                </div>
                                @endif
                            ...
                            <div class="flex gap-3 justify-end items-center pt-5 mt-8 border-t">
                                ...
                                <button type="submit" class="px-10 btn btn-warning">
                                    <span wire:loading wire:target="update" class="inline-block mr-2 w-4 h-4 rounded-full border-2 border-white animate-spin border-l-transparent"></span>
