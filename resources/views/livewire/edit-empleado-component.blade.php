    ...
    <div x-data="{ open: @entangle('showModal') }">
        <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60" :class="{ '!block': open }">
            <div class="flex min-h-screen items-center justify-center px-4" @click.self="open = false">
                <div x-show="open" x-transition.duration.300 class="panel my-8 w-full max-w-lg overflow-hidden border-0 p-0 shadow-lg">
                        ...
                        <form wire:submit.prevent="update" autocomplete="off" autocapitalize="off" spellcheck="false">
                            ...
                            <div class="mt-8 flex items-center justify-end">
                                ...
                                <button type="submit" class="btn btn-primary ltr:ml-4 rtl:mr-4">
                                    <span wire:loading wire:target="update" class="animate-spin inline-block mr-2 w-3 h-3 border-2 border-white border-t-transparent rounded-full"></span>
                                    Guardar Cambios
                                </button>
                            </div>
                        </form>
