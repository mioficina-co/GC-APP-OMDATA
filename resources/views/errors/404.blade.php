    ...
    <div class="relative flex min-h-screen items-center justify-center overflow-hidden">
        <div
            ...
            <div class="relative">
                ...
                <p class="mt-5 text-base dark:text-white">¡Ups! La página que buscas no existe.</p>
                <a href="{{ url('/') }}" class="btn btn-gradient mx-auto !mt-7 w-max border-0 uppercase shadow-none">
                    Volver al Inicio
                </a>
            </div>
        </div>
