            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <a href="{{ route('dashboard') }}" wire:navigate
                        ...
                        <div class="flex items-center">
                            {{-- Icono SVG --}}
                            <svg class="group-hover:!text-primary shrink-0 {{ request()->routeIs('dashboard') ? '!text-primary' : '' }}"
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'perfil' }"
                        @click="activeDropdown === 'perfil' ? activeDropdown = null : activeDropdown = 'perfil'">
                        <div class="flex items-center">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'perfil'" x-collapse class="text-gray-500 sub-menu">
                        <li>
                            <a href="{{ route('perfil.ver') }}">Ver mi perfil</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        ...
                        @click="activeDropdown === 'visitantes' ? activeDropdown = null : activeDropdown = 'visitantes'">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        ...
                        @click="activeDropdown === 'empleados' ? activeDropdown = null : activeDropdown = 'empleados'">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        ...
                        @click="activeDropdown === 'politica' ? activeDropdown = null : activeDropdown = 'politica'">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Politicas</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'politica'" x-collapse class="text-gray-500 sub-menu">
                        <li>
                            <a href="{{ route('politicas.registro') }}">Registro politicas</a>
                        </li>
                        <li>
                            <a href="{{ route('politicas.listar') }}">Ver politicas</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        ...
                        @click="activeDropdown === 'visitas' ? activeDropdown = null : activeDropdown = 'visitas'">
                        <div class="flex items-center">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'visitas'" x-collapse class="text-gray-500 sub-menu">
                        <li>
                            <a href="{{ route('visitas.listar') }}">Ver visitas</a>
                        </li>
                    </ul>
                </li>
            </ul>
