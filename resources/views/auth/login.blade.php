        ...
        <div
            ...
            <div
                ...
                <div class="w-full max-w-[440px] lg:mt-16">
                    ...
                    @if (session('status'))
                        <div
                            class="p-4 mb-4 text-sm font-bold text-green-500 rounded border bg-green-500/10 border-green-500/20">
                            {{ session('status') }}
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <div class="flex justify-between items-center">
                            <label class="flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 font-semibold text-white-dark">Recordarme</span>
                            </label>
