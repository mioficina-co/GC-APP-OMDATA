...
<x-guest-layout>
    ...
    <div x-data="auth">
        <div class="absolute inset-0 bg-gradient-to-b from-white to-blue-500">
            <img src="/assets/images/auth/bg-gradient.png" alt="Imagen de fondo" class="h-full w-full object-cover opacity-50" />
        </div>
        <div class="relative flex min-h-screen items-center justify-center bg-[url(/assets/images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
            <img src="/assets/images/auth/coming-soon-object1.png" alt="Elemento decorativo 1" class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
            <img src="/assets/images/auth/coming-soon-object2.png" alt="Elemento decorativo 2" class="absolute left-24 top-0 h-40 md:left-[30%]" />
            <img src="/assets/images/auth/coming-soon-object3.png" alt="Elemento decorativo 3" class="absolute right-0 top-0 h-[300px]" />
            <img src="/assets/images/auth/polygon-object.svg" alt="Elemento decorativo 4" class="absolute bottom-0 end-[28%]" />
                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    <div class="w-full max-w-[440px] lg:mt-16">
                        <div class="mb-10">
                            ...
                            <p class="text-base font-bold leading-normal text-white-dark">Ingresa tu correo electrónico y contraseña para acceder</p>
                        </div>
                        <form method="POST" action="{{ route('login') }}">
                            @csrf
                            <div>
